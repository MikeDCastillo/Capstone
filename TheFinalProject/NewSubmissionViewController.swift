...
//    }
    ...
    @IBAction func saveButtonTapped(_ sender: Any) {
        ...
        let newSubmission = Submission(id: "", userId: user.id, memeId: meme.id, topText: actualTopText, bottomText: actualBottomText, textColor: currentColor)
    
        submissionController.save(newSubmission)
        dismiss(animated: true, completion: nil)
    }
